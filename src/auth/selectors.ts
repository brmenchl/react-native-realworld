...
export const getIsLoggedIn = createSelector(getAuthState, (user) => user !== guest);

export const getUserWithProfile = createSelector(getAuthState, getProfilesState, (user, profiles) =>
  user !== guest
    ? ({
        user,
